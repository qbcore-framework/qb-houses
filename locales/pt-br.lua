local Translations = {
    error = {
        ...
        ["no_house"] = "Não há nenhuma casa perto de você",
        ["no_door"] = "Você não está perto da porta...",
        ["locked"] = "A casa está trancada!",
        ["no_one_near"] = "Ninguém por perto!",
        ["not_owner"] = "Você não é o dono desta casa.",
        ...
        ["no_invasion"] = "Esta porta não está aberta...",
        ["realestate_only"] = "Apenas imobiliária pode usar este comando",
    ...
    info = {
        ...
        ["create_house"] = "Criar Casa (Apenas Imobiliária)",
        ["price_of_house"] = "Preço da casa",
        ["tier_number"] = "Nível da casa",
        ["add_garage"] = "Adicionar Garagem à Casa (Apenas Imobiliária)",
